...
/**
 * servicio encargado de realizar respaldos a la base de datos de manera
 * automatica
 *
 * @author IgnacioGrez
 *
...
public class BackupService {
	...
	@Value("${backup.pathname}") /// debe ser definido en el aplication.propertires. ruta donde se guardaran los
									/// backups
	...
	public void makeBackup() throws ClassNotFoundException, IOException, SQLException {
		...
		// por como se ejecuta, la carpeta bin de mysql debe de estar en el PATH del
		// sistema. si no, debe darse la ruta completa al ejecutable de mysqldump
		String executeCmd = "mysqldump -u " + databaseUsername + " -p" + databasePassword + "  --databases "
				+ databaseName
				+ " -r " + savePath;
